...
<div class="row">
                ...
                <table class="table table-bordered table-striped display nowrap dataTable" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$account->name}}</td>
                            <td>
                                <a href="{{ route('view_account')."/".$account->id }}" class="btn btn-success btn-flat btn-xs" title="View">
                                    <i class="fa fa-eye"></i>
                                </a>
                            <button type="button" data-toggle="modal" data-target="#{{$account->id}}" class="btn btn-primary btn-flat btn-xs">
                                <i class="fa fa-pencil"></i>
                            </button>
                            <a href="{{route('deleteAccountSub')."/".$account->id}}">
    ...
    <div class="modal-dialog modal-sm">
        <form action="{{route('editAccountSubType')}}" method="post">
            {{csrf_field()}}
        <div class="modal-content">
            ...
            <form action="">
                <div class="modal-body">
                    <input type="hidden" name="account_sub_type_id" value="{{$account->id}}">
...
<div class="modal fade" id="newCategory" role="dialog">
    <div class="modal-dialog modal-sm">
        <form action="{{route('addAccountSubType')}}" method="post">
            {{csrf_field()}}
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            ...
            <form action="">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="categoryName">Account Sub Category Name:</label>
